...
class AppWindow:
	...
	def __init__(self):
		...
		self._laptop_button = gui.Button("Laptop")
		self._laptop_button.horizontal_padding_em = 0.5
		self._laptop_button.vertical_padding_em = 0
		self._laptop_button.set_on_clicked(self._set_object_laptop)
		h = gui.Horiz(0.25 * em)
		h.add_stretch()
		h.add_child(self._dish_button)
		h.add_child(self._laptop_button)
		h.add_stretch()
