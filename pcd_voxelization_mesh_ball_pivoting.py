...
tableware_ply_path = "/home/fuxiao/Projects/Orbbec/concept-graphs/conceptgraph/dataset/external/tableware_4_16/exps/exp_default/tableware_4_16_bowl_denoised.ply"
...
radii = [0.005, 0.01, 0.02, 0.04] # radii = [0.005, 0.01, 0.02, 0.04]
...
# vertices_to_remove = densities < np.quantile(densities, 0.15) #set the density threshold #output bool
