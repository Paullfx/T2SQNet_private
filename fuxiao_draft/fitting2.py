...
def visualize_voxels_with_open3d_single(voxel_dict, exp_index):
    ...
    if isinstance(voxel_dict, dict):
        ...
        if isinstance(voxel_data, torch.Tensor):
            ...
            o3d.visualization.draw_geometries([second_voxel_grid],
                                              window_name=f'Voxel Hull - Part 2 - Experiment {exp_index}')

            # Matplotlib voxel visualization
            fig = plt.figure()
